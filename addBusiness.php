      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-11 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.html" class="text-black h2 mb-0">Add new place</a></h1>
          </div>
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">

              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                <li><a href="indexA.html"><span>Go back</span></a></li>

                <li class="active"><a href="#"><span>Add new Place</span></a></li>
              </ul>
            </nav>
          </div>
          ...
          <div class="col-md-10">
            ...
            <div class="row justify-content-center">
              <div class="col-md-8 text-center">
                <h1 data-aos="fade-up">Add New Places With ease</h1>
                <p class="mb-0" data-aos="fade-up" data-aos-delay="100">--------</p>
              </div>
            </div>
            ...
            <form action="#" class="p-5 bg-white">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="email" id="location_t" class="form-control">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="Desc" cols="30" rows="7" class="form-control" placeholder="Write a good description of your business here..."></textarea>
                </div>
              </div>
