            ...
            <form action="#" class="p-5 bg-white">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="pass" id="subject" class="form-control">
                </div>
              </div>
			   <div class="row form-group">
              ...
              <div class="row form-group" style="border:0px;border-left: 1px; border-style: solid;" >
                
                <form action="signup.php?h=true" method="post" class="p-5 bg-white">
                <div class="col-md-12">
                  <label class="text-black" for="subject">Email</label> 
                  <input type="pass" name="emailin" class="form-control">
                </div>
                ...
                <div class="col-md-12"  >
                  <label class="text-black" for="subject">Password</label> 
                  <input type="pass" name="passin" class="form-control">
               
              </div>

             <div class="row form-group" style="margin-top: 10px;margin-left: 10px;">
                <div class="col-md-2">
